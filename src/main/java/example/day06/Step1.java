...
public class Step1 {
    public static void main(String[] args) {
        ...
        //  wrapper 클래스 : 기본타입 -> 참조타입, 기본 타입을 참조 타입으로 만들기
            //  기본타입을 참조타입으로 사용해야하는 경우가 있다.
                //  기본타입은 클래스가 아니므로 멤버변수나 메소드를 포함하지 않는다.
                //  기본타입의 데이터가 메소드 / 기능를(을) 사용해야하는 경우가 있을 수 있다. (주로 타입변환)
        int value1 = 100;                             //  기본타입 100
        // value1. (x) -> 도트 연산자를 사용할 수 없다.
        Integer value2 = new Integer(100);      //  참조타입 100, wrapper 클래스
        ...
        System.out.println("myValue = " + myValue);
            ...
            //  2) Integer.valueOf(정수나 문자열) : Integer 객체 반환 메소드
        Integer value3 = Integer.valueOf("100");
        Integer value4 = Integer.valueOf(100);

            //  3) * Integer.parseInt(문자열) : int 타입으로 반환해주는 메소드
        //  문자열 타입을 기본 타입으로 변환 : 주로 자바 외의 데이터를 가져올 때
        ...
        for(Field f : fields){
            ...
            //  3. String 클래스의 모든 메소드 정보(선언부) 호출
